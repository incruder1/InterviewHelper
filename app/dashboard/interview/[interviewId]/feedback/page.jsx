...
import { listAnswers } from "@/utils/api";
...
const Feedback = ({ params }) => {
  ...
  const GetFeedback = async () => {
    try {
      ...
      const result = await listAnswers(token, params.interviewId);
            ...
            <Collapsible key={index} className="mt-7">
              ...
              <CollapsibleContent>
                <div className="flex flex-col gap-2">
                  ...
                  <h2 className="p-2 border rounded-lg bg-blue-50 text-sm text-primary-900 dark:text-black">
